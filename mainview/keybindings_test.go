...
func TestActionForKey(t *testing.T) {
	tests := []struct {
		...
		{key: "r", expectedAction: actionToggleRepeat, found: true},
		{key: "z", expectedAction: actionToggleShuffle, found: true},
		...
		{key: "2", expectedAction: actionShowAlbums, found: true},
		{key: "3", expectedAction: actionShowPlaylists, found: true},
